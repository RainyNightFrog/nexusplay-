/**
 * Generate public/sdk/rnf-game-packs.js from Traditional Chinese source + EN/zh-CN packs.
 * Run: node scripts/generate-rnf-game-packs.mjs
 */
import fs from "node:fs";

const zhHK = JSON.parse(fs.readFileSync("scripts/_extracted-game-content.json", "utf8"));

/** @type {Record<string, { subtitle: string, highlights: string[], help: { about: string, features: string[], controls: string[], tips: string[] } }>} */
const en = {
  "cyber-bubble-pop": {
    subtitle: "Aim preview · Lightning / black hole / bomb · Chain combos · Ceiling push · Touch aim",
    highlights: ["4 difficulties", "Special bubbles", "Chain clears", "Ceiling push", "Touch ready"],
    help: {
  ...
  "cyber-neon-runner": {
    ...
    highlights: ["Varied hazards", "Shield magnet boost", "Combo multiplier", "Milestones", "3 mobile keys"],
    help: {
  ...
  "galactic-invader-2026": {
    ...
    highlights: ["Boss waves", "Weapon upgrades", "Shield pickups", "Barrage patterns", "Touch ready"],
    help: {
  ...
  "memory-matrix-glitch": {
    ...
    highlights: ["Glitch FX", "Combo tones", "Timed stages", "Bomb cards", "Touch flip"],
    help: {
  ...
  "neon-snake-extreme": {
    ...
    highlights: ["4 difficulties", "Bullet time", "Leaderboard", "Sensitivity / speed"],
    help: {
  ...
  "neon-tetromino-rush": {
    ...
    highlights: ["5-piece preview", "Neon frenzy", "Line combos", "Garbage rows", "Mobile pad"],
    help: {
  ...
  "overdrive-cyber-pong": {
    ...
    highlights: ["Curveball", "Gravity wells", "Touch drag", "Particle trails", "Versus"],
    help: {
  ...
  "quantum-tic-tac-toe": {
    ...
    highlights: ["Quantum entangle", "5×5 five-in-a-row", "Timed turns", "Win streaks", "Touch place"],
    help: {
  ...
  "rainy-frog-dash": {
    ...
    highlights: ["Formation hazards", "Shield & rocket", "Coin combos", "Weather phases", "3 mobile keys"],
    help: {
  ...
  "void-brick-breaker": {
    ...
    highlights: ["4 difficulties", "Multi-ball / laser", "Special bricks", "Break combos", "Touch ready"],
    help: {
...
/** Simplified Chinese packs (mirrors zh-HK meaning). */
const zhCN = {
  "cyber-bubble-pop": {
    subtitle: "弹道预览 · 闪电／黑洞／炸弹 · 连锁 Combo · 顶部下压 · 触控瞄准",
    highlights: ["四段难度", "特殊泡泡", "连锁消除", "顶部下压", "触控就绪"],
    help: {
  ...
  "cyber-neon-runner": {
    ...
    highlights: ["多型障碍", "护盾磁铁加速", "Combo 倍率", "里程碑事件", "手机三键"],
    help: {
  ...
  "galactic-invader-2026": {
    ...
    highlights: ["BOSS 波", "武器升级", "护盾道具", "弹幕模式", "触控就绪"],
    help: {
  ...
  "memory-matrix-glitch": {
    ...
    highlights: ["Glitch 特效", "连击音阶", "限时关卡", "炸弹卡", "触控翻牌"],
    help: {
  ...
  "neon-snake-extreme": {
    ...
    highlights: ["四段难度", "子弹时间", "排行榜", "灵敏度／速度"],
    help: {
  ...
  "neon-tetromino-rush": {
    ...
    highlights: ["五格预览", "霓虹狂热", "连消 Combo", "难度垃圾行", "手机虚拟键"],
    help: {
  ...
  "overdrive-cyber-pong": {
    ...
    highlights: ["曲球轨迹", "重力井", "触控拖曳", "粒子拖尾", "双人对战"],
    help: {
  ...
  "quantum-tic-tac-toe": {
    ...
    highlights: ["量子纠缠", "5×5 连五", "限时回合", "连胜纪录", "触控落子"],
    help: {
  ...
  "rainy-frog-dash": {
    ...
    highlights: ["多段障碍编队", "护盾火箭道具", "Combo 金币", "天气相位", "手机三键"],
    help: {
  ...
  "void-brick-breaker": {
    ...
    highlights: ["四段难度", "多球／激光", "特殊砖块", "Combo 连破", "触控就绪"],
    help: {
...
const packs = {};
for (const slug of Object.keys(zhHK)) {
  const src = zhHK[slug];
  packs[slug] = {
    "zh-HK": {
...
const out =
  "/**\n * Auto-generated game subtitle / help packs. Do not edit by hand —\n * run: node scripts/generate-rnf-game-packs.mjs\n */\n" +
  "(function (global) {\n  \"use strict\";\n  global.RNF_GAME_PACKS = " +
  JSON.stringify(packs, null, 2) +
  ";\n})(typeof window !== \"undefined\" ? window : this);\n";

fs.writeFileSync("public/sdk/rnf-game-packs.js", out, "utf8");
console.log("wrote public/sdk/rnf-game-packs.js", Object.keys(packs).length, "games");
