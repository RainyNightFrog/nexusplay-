    ...
    <div className="dark relative min-h-full text-zinc-100">
      ...
      <main className="mx-auto max-w-5xl px-4 py-8 sm:px-6">
        ...
        <div className="mb-8 flex gap-4">
          <div className="size-20 animate-pulse rounded-xl bg-zinc-800" />
...
export default function ForumPageClient({
  ...
  return (
    <Suspense fallback={<ForumPageShell />}>
      <GameForumContent initialGame={initialGame} routeId={routeId} />
    </Suspense>
  );
}
...
function GameForumContent({
  ...
  useEffect(() => {
    ...
    async function loadGame() {
      ...
      try {
        ...
        if (!cancelled && !initialGame) setGame(null);
      } finally {
  ...
  }, [gameId, router, initialGame]);

  if (loading) {
    return <ForumPageShell />;
  }
