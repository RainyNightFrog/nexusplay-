...
const GAME_FIELDS =
  "id, title, description, category, cover_url, game_url, creator_id, created_at, plays_count, rating_avg, publish_status, status, rejection_reason, tips_enabled, suggested_tip_amount";
