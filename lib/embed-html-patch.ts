...
/* 版面與 void-gacha.com／itch-embed 一致：只在右側留 side-nav，勿左右對稱雙倍留白把主畫面擠亂 */
html.void-rainynightfrog-embed.np-embed-expanded:not(.void-itch-mobile-shell),
html.void-itch-embed.void-itch-expanded:not(.void-itch-mobile-shell){--void-side-nav:102px;--void-mobile-nav-h:0px}
...
html.void-itch-embed:not(.void-itch-mobile-shell).void-itch-expanded #screen-app{display:block!important;visibility:visible!important;height:auto!important;max-height:none!important;min-height:100%!important;overflow:visible!important;padding-top:var(--void-app-header-offset,clamp(108px,13vh,148px))!important;padding-bottom:max(24px,env(safe-area-inset-bottom,0px))!important;padding-left:max(10px,env(safe-area-inset-left,0px))!important;padding-right:calc(var(--void-side-nav,102px) + max(10px,env(safe-area-inset-right,0px)))!important}
...
html.void-rainynightfrog-embed.np-embed-expanded:not(.void-itch-mobile-shell) #screen-app>.side-nav .nav-icon{font-size:clamp(16px,2.35vh,22px)!important}
html.void-rainynightfrog-embed.np-embed-expanded:not(.void-itch-mobile-shell) #screen-app>.side-nav .nav-label{font-size:clamp(9px,1.12vh,11px)!important;line-height:1.15!important}
html.void-rainynightfrog-embed.np-embed-expanded:not(.void-itch-mobile-shell) #screen-app>.app-header{position:fixed!important;top:0!important;left:0!important;width:100%!important;z-index:999;display:grid!important;grid-template-columns:auto minmax(0,1fr) auto!important;align-items:center!important;gap:10px 14px!important;padding:10px calc(var(--void-side-nav,102px) + 12px) 10px 16px!important;box-sizing:border-box!important;visibility:visible!important}
